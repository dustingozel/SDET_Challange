...
test('@UI Login Validation by Sending Empty Username', async () => {
...
test('@UI Login Validation by Sending Empty Password', async () => {
  const login = new LoginPage(page);
...
test('@UI Login Validation by Sending Empty Username and Password', async () => {
  const login = new LoginPage(page);
...
test('@UI Login Validation by Sending Wrong Username - Password', async () => {
  const login = new LoginPage(page);
...
test('@UI Login Validation', async () => {
  const login = new LoginPage(page);
